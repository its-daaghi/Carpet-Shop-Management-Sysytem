...
from .views import ProductTypeViewSet, DesignViewSet, ColorViewSet, RollViewSet, EmployeeViewSet, SalaryPaymentViewSet, ExpenseViewSet, FactoryViewSet, FactoryPaymentViewSet, SaleViewSet, SaleItemViewSet, AdditionalStockViewSet
...
router.register(r'additional-stocks', AdditionalStockViewSet, basename='additionalstock')
